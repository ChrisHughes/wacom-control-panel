...
import gnomevfs
import gio
# Filemonitor comes from the mayanna source code. Credit goes to their authors
...
class FileMonitor(gobject.GObject):
    ...
    def _queue_event(self, monitor_uri, info_uri, event):
        ...
        self.pending_timeouts[info_uri] = gobject.timeout_add(250, self._timeout_cb, monitor_uri, info_uri, event)
